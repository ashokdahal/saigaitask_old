...
/**
 * {@link FacebookInfo}のプロパティ名の集合です。
 *
 */
...
public class FacebookInfoNames implements EntityNameInterface {
     ...
     * @author S2JDBC-Gen
     */
    public static class _FacebookInfoNames extends PropertyName<FacebookInfo> {

        /**
         * インスタンスを構築します。
         */
        public _FacebookInfoNames() {
        }
         ...
         *            名前
         */
        public _FacebookInfoNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _FacebookInfoNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
