...
/**
 * {@link NoticetypeMaster}のプロパティ名の集合です。
 * 
 */
...
public class NoticetypeMasterNames {
     ...
     * @author S2JDBC-Gen
     */
    public static class _NoticetypeMasterNames extends PropertyName<NoticetypeMaster> {

        /**
         * インスタンスを構築します。
         */
        public _NoticetypeMasterNames() {
        }
         ...
         *            名前
         */
        public _NoticetypeMasterNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _NoticetypeMasterNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
