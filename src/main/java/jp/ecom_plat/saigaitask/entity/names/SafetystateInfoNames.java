...
/**
 * {@link SafetystateInfo}のプロパティ名の集合です。
 *
 */
@Generated(value = {"S2JDBC-Gen 2.4.45", "org.seasar.extension.jdbc.gen.internal.model.NamesModelFactoryImpl"}, date = "2015/10/05 16:20:31")
public class SafetystateInfoNames implements EntityNameInterface {

	@Override
	public String entityName() {
		return "Staff request safety response status data";
	}
     ...
     * @author S2JDBC-Gen
     */
    public static class _SafetystateInfoNames extends PropertyName<SafetystateInfo> {

        /**
         * インスタンスを構築します。
         */
        public _SafetystateInfoNames() {
        }
         ...
         *            名前
         */
        public _SafetystateInfoNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _SafetystateInfoNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
