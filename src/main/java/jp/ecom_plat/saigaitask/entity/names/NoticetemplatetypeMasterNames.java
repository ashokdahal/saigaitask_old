...
/**
 * {@link NoticetemplatetypeMaster}のプロパティ名の集合です。
 * 
 */
...
public class NoticetemplatetypeMasterNames {
     ...
     * @author S2JDBC-Gen
     */
    public static class _NoticetemplatetypeMasterNames extends PropertyName<NoticetemplatetypeMaster> {

        /**
         * インスタンスを構築します。
         */
        public _NoticetemplatetypeMasterNames() {
        }
         ...
         *            名前
         */
        public _NoticetemplatetypeMasterNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _NoticetemplatetypeMasterNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
