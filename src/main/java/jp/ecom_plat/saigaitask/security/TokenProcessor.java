...
/**
 * struts1 の TokenProcessor を Spring に移行
 */
public class TokenProcessor {
    ...
    private static final String TOKEN_KEY = "saigaitask._synchronizerToken";
    ...
    public synchronized boolean isTokenValid(HttpServletRequest request, boolean reset) {
        ...
        String token = request.getParameter(getTokenKey());
        if (token == null) {
            return false;
        }
    ...
    public synchronized void saveToken(HttpServletRequest request) {
        ...
        if (token != null) {
            session.setAttribute(getTokenKey(), token);
        }
    ...
    public synchronized String getToken(HttpServletRequest request) {
        ...
        // Retrieve the transaction token from this session, and
        // reset it if requested
        String saved = (String) session.getAttribute(getTokenKey());
        return saved;
    }
