...
/**
 * {@link MeteovolcanoMaster}のプロパティ名の集合です。
 * 
 */
...
public class MeteovolcanoMasterNames {
     ...
     * @author S2JDBC-Gen
     */
    public static class _MeteovolcanoMasterNames extends PropertyName<MeteovolcanoMaster> {

        /**
         * インスタンスを構築します。
         */
        public _MeteovolcanoMasterNames() {
        }
         ...
         *            名前
         */
        public _MeteovolcanoMasterNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _MeteovolcanoMasterNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
