...
/**
 * {@link MeteoriverareaMaster}のプロパティ名の集合です。
 * 
 */
@Generated(value = {"S2JDBC-Gen 2.4.45", "org.seasar.extension.jdbc.gen.internal.model.NamesModelFactoryImpl"}, date = "2013/09/05 10:58:08")
public class MeteoriverareaMasterNames {
     ...
     * @author S2JDBC-Gen
     */
    public static class _MeteoriverareaMasterNames extends PropertyName<MeteoriverareaMaster> {

        /**
         * インスタンスを構築します。
         */
        public _MeteoriverareaMasterNames() {
        }
         ...
         *            名前
         */
        public _MeteoriverareaMasterNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _MeteoriverareaMasterNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
