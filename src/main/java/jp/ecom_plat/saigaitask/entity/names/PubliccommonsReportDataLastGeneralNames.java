...
/**
 * {@link PubliccommonsReportDataLastGeneral}のプロパティ名の集合です。
 *
 */
...
public class PubliccommonsReportDataLastGeneralNames implements EntityNameInterface {

	@Override
	public String entityName() {
		return "L-Alert last notice sending history data";
	}
     ...
     * @author S2JDBC-Gen
     */
    public static class _PubliccommonsReportDataLastGeneralNames extends PropertyName<PubliccommonsReportDataLastGeneral> {

        /**
         * インスタンスを構築します。
         */
        public _PubliccommonsReportDataLastGeneralNames() {
        }
         ...
         *            名前
         */
        public _PubliccommonsReportDataLastGeneralNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _PubliccommonsReportDataLastGeneralNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
