...
<xsl:template match="/">
	...
	<xsl:for-each select="jmx:Report/jmx_ib:Head/jmx_ib:Headline/jmx_ib:Information/jmx_ib:Item">
		...
		<!-- 警報名,type=comboboxsave,levelflag=1_field,groupid=1 -->
		<xsl:value-of select="jmx_ib:Kind/jmx_ib:Name"/>

		<!-- 警報コード,type=combobox,dbuid=dbwarncode,levelflag=1_field,groupid=1 -->
		...
		<xsl:for-each select="jmx_ib:Areas/jmx_ib:Area">
			...
			<!-- 領域コード,type=combobox,dbuid=dbkishoukeihoucode,levelflag=1_1_field,groupid=2 -->
