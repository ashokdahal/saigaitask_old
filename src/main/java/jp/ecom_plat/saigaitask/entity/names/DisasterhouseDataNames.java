...
/**
 * {@link DisasterhouseData}のプロパティ名の集合です。
 * 
 */
...
public class DisasterhouseDataNames implements EntityNameInterface {

	@Override
	public String entityName() {
		return "House damage data";
	}
     ...
     * @author S2JDBC-Gen
     */
    public static class _DisasterhouseDataNames extends PropertyName<DisasterhouseData> {

        /**
         * インスタンスを構築します。
         */
        public _DisasterhouseDataNames() {
        }
         ...
         *            名前
         */
        public _DisasterhouseDataNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _DisasterhouseDataNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
