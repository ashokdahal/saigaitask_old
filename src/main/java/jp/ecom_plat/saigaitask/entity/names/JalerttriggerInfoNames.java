...
/**
 * {@link JalerttriggerInfo}のプロパティ名の集合です。
 *
 */
...
public class JalerttriggerInfoNames implements EntityNameInterface {

	@Override
	public String entityName() {
		return "JAlert info trigger info";
	}
    ...
    /**
     * jalertrequestInfoのプロパティ名を返します。
     *
     * @return jalertrequestInfoのプロパティ名
     */
    public static _JalertrequestInfoNames jalertrequestInfo() {
        return new _JalertrequestInfoNames("jalertrequestInfo");
    }
     ...
     * @author S2JDBC-Gen
     */
    public static class _JalerttriggerInfoNames extends PropertyName<JalerttriggerInfo> {

        /**
         * インスタンスを構築します。
         */
        public _JalerttriggerInfoNames() {
        }
         ...
         *            名前
         */
        public _JalerttriggerInfoNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _JalerttriggerInfoNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
         ...
         * @return jalertrequestInfoのプロパティ名
         */
        public _JalertrequestInfoNames jalertrequestInfo() {
            return new _JalertrequestInfoNames(this, "jalertrequestInfo");
        }
