...
/**
 * {@link ObservatoryrainlayerInfo}のプロパティ名の集合です。
 *
 */
...
public class ObservatoryrainlayerInfoNames implements EntityNameInterface {

	@Override
	public String entityName() {
		return "Rainfall observation point layer info";
	}
     ...
     * @author S2JDBC-Gen
     */
    public static class _ObservatoryrainlayerInfoNames extends PropertyName<ObservatoryrainlayerInfo> {

        /**
         * インスタンスを構築します。
         */
        public _ObservatoryrainlayerInfoNames() {
        }
         ...
         *            名前
         */
        public _ObservatoryrainlayerInfoNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _ObservatoryrainlayerInfoNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
