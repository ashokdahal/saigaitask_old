...
/**
 * {@link ClearinghousemetadataInfo}のプロパティ名の集合です。
 * 
 */
...
public class ClearinghousemetadataInfoNames implements EntityNameInterface {

	@Override
	public String entityName() {
		return "Clearing house prior data info";
	}
     ...
     * @author S2JDBC-Gen
     */
    public static class _ClearinghousemetadataInfoNames extends PropertyName<ClearinghousemetadataInfo> {

        /**
         * インスタンスを構築します。
         */
        public _ClearinghousemetadataInfoNames() {
        }
         ...
         *            名前
         */
        public _ClearinghousemetadataInfoNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _ClearinghousemetadataInfoNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
