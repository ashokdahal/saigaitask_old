...
/**
 * {@link ObservatoryriverInfo}のプロパティ名の集合です。
 *
 */
...
public class ObservatoryriverInfoNames implements EntityNameInterface {

	@Override
	public String entityName() {
		return "River water level observation point info";
	}
    ...
    /**
     * waterlevel1のプロパティ名を返します。
     *
     * @return waterlevel1のプロパティ名
     */
    public static PropertyName<Float> waterlevel1() {
        return new PropertyName<Float>("waterlevel1");
    }

    /**
     * waterlevel2のプロパティ名を返します。
     *
     * @return waterlevel2のプロパティ名
     */
    public static PropertyName<Float> waterlevel2() {
        return new PropertyName<Float>("waterlevel2");
    }

    /**
     * waterlevel3のプロパティ名を返します。
     *
     * @return waterlevel3のプロパティ名
     */
    public static PropertyName<Float> waterlevel3() {
        return new PropertyName<Float>("waterlevel3");
    }

    /**
     * waterlevel4のプロパティ名を返します。
     *
     * @return waterlevel4のプロパティ名
     */
    public static PropertyName<Float> waterlevel4() {
        return new PropertyName<Float>("waterlevel4");
    }

    /**
     * waterlevel5のプロパティ名を返します。
     *
     * @return waterlevel5のプロパティ名
     */
    public static PropertyName<Float> waterlevel5() {
        return new PropertyName<Float>("waterlevel5");
    }

    /**
     * levelmaxのプロパティ名を返します。
     *
     * @return levelmaxのプロパティ名
     */
    public static PropertyName<Float> levelmax() {
        return new PropertyName<Float>("levelmax");
    }

    /**
     * levelminのプロパティ名を返します。
     *
     * @return levelminのプロパティ名
     */
    public static PropertyName<Float> levelmin() {
        return new PropertyName<Float>("levelmin");
    }

    /**
     * levelbaseのプロパティ名を返します。
     *
     * @return levelbaseのプロパティ名
     */
    public static PropertyName<Float> levelbase() {
        return new PropertyName<Float>("levelbase");
    }
     ...
     * @author S2JDBC-Gen
     */
    public static class _ObservatoryriverInfoNames extends PropertyName<ObservatoryriverInfo> {

        /**
         * インスタンスを構築します。
         */
        public _ObservatoryriverInfoNames() {
        }
         ...
         *            名前
         */
        public _ObservatoryriverInfoNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _ObservatoryriverInfoNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
         ...
         * @return waterlevel1のプロパティ名
         */
        public PropertyName<Float> waterlevel1() {
            return new PropertyName<Float>(this, "waterlevel1");
        }
         ...
         * @return waterlevel2のプロパティ名
         */
        public PropertyName<Float> waterlevel2() {
            return new PropertyName<Float>(this, "waterlevel2");
        }
         ...
         * @return waterlevel3のプロパティ名
         */
        public PropertyName<Float> waterlevel3() {
            return new PropertyName<Float>(this, "waterlevel3");
        }
         ...
         * @return waterlevel4のプロパティ名
         */
        public PropertyName<Float> waterlevel4() {
            return new PropertyName<Float>(this, "waterlevel4");
        }
         ...
         * @return waterlevel5のプロパティ名
         */
        public PropertyName<Float> waterlevel5() {
            return new PropertyName<Float>(this, "waterlevel5");
        }
         ...
         * @return levelmaxのプロパティ名
         */
        public PropertyName<Float> levelmax() {
            return new PropertyName<Float>(this, "levelmax");
        }
         ...
         * @return levelminのプロパティ名
         */
        public PropertyName<Float> levelmin() {
            return new PropertyName<Float>(this, "levelmin");
        }
         ...
         * @return levelbaseのプロパティ名
         */
        public PropertyName<Float> levelbase() {
            return new PropertyName<Float>(this, "levelbase");
        }
