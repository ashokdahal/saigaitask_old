...
/**
 * {@link MeteorainareaMaster}のプロパティ名の集合です。
 * 
 */
...
public class MeteorainareaMasterNames {
     ...
     * @author S2JDBC-Gen
     */
    public static class _MeteorainareaMasterNames extends PropertyName<MeteorainareaMaster> {

        /**
         * インスタンスを構築します。
         */
        public _MeteorainareaMasterNames() {
        }
         ...
         *            名前
         */
        public _MeteorainareaMasterNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _MeteorainareaMasterNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
