...
/**
 * {@link MapkmllayerInfo}のプロパティ名の集合です。
 * 
 */
@Generated(value = {"S2JDBC-Gen 2.4.45", "org.seasar.extension.jdbc.gen.internal.model.NamesModelFactoryImpl"}, date = "2015/04/17 18:05:18")
public class MapkmllayerInfoNames implements EntityNameInterface {

	@Override
	public String entityName() {
		return "Map KML layer info";
	}
     ...
     * @author S2JDBC-Gen
     */
    public static class _MapkmllayerInfoNames extends PropertyName<MapkmllayerInfo> {

        /**
         * インスタンスを構築します。
         */
        public _MapkmllayerInfoNames() {
        }
         ...
         *            名前
         */
        public _MapkmllayerInfoNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _MapkmllayerInfoNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
