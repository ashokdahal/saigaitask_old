 ...
 */
@Entity
@Table(name = "localgovtype_master")
...
@lombok.ToString(exclude={"localgovInfos"})
public class LocalgovtypeMaster implements Serializable {
    ...
    /** 地方自治体情報リスト */
    @OneToMany(mappedBy="localgovtypeMaster")
