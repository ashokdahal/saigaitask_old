...
/**
 * {@link LandmarkInfo}のプロパティ名の集合です。
 *
 */
...
public class LandmarkInfoNames implements EntityNameInterface {
    ...
    /**
     * landmarkDataListのプロパティ名を返します。
     *
     * @return landmarkDataListのプロパティ名
     */
    public static _LandmarkDataNames landmarkDataList() {
        return new _LandmarkDataNames("landmarkDataList");
    }
     ...
     * @author S2JDBC-Gen
     */
    public static class _LandmarkInfoNames extends PropertyName<LandmarkInfo> {

        /**
         * インスタンスを構築します。
         */
        public _LandmarkInfoNames() {
        }
         ...
         *            名前
         */
        public _LandmarkInfoNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _LandmarkInfoNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
         ...
         * @return landmarkDataListのプロパティ名
         */
        public _LandmarkDataNames landmarkDataList() {
            return new _LandmarkDataNames(this, "landmarkDataList");
        }
