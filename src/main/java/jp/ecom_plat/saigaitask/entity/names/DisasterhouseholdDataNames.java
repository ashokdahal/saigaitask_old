...
/**
 * {@link DisasterhouseholdData}のプロパティ名の集合です。
 * 
 */
...
public class DisasterhouseholdDataNames implements EntityNameInterface {

	@Override
	public String entityName() {
		return "House damage ( household ) data";
	}
     ...
     * @author S2JDBC-Gen
     */
    public static class _DisasterhouseholdDataNames extends PropertyName<DisasterhouseholdData> {

        /**
         * インスタンスを構築します。
         */
        public _DisasterhouseholdDataNames() {
        }
         ...
         *            名前
         */
        public _DisasterhouseholdDataNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _DisasterhouseholdDataNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
