 ...
 */
@Entity
@Table(name = "observatoryrain_info")
@Generated(value = {"S2JDBC-Gen 2.4.45", "org.seasar.extension.jdbc.gen.internal.model.EntityModelFactoryImpl"}, date = "2014/02/24 19:22:25")
@lombok.Getter @lombok.Setter
public class ObservatoryrainInfo implements Serializable {
    ...
    public Long getPointFullCode() {
    	try {
        	...
        	String code = ""+officecode+"001"+df.format(obsrvtncode);
