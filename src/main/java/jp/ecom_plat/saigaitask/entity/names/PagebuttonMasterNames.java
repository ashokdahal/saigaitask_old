...
/**
 * {@link PagebuttonMaster}のプロパティ名の集合です。
 * 
 */
...
public class PagebuttonMasterNames {
     ...
     * @author S2JDBC-Gen
     */
    public static class _PagebuttonMasterNames extends PropertyName<PagebuttonMaster> {

        /**
         * インスタンスを構築します。
         */
        public _PagebuttonMasterNames() {
        }
         ...
         *            名前
         */
        public _PagebuttonMasterNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _PagebuttonMasterNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
