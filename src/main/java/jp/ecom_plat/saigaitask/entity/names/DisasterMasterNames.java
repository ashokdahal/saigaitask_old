...
/**
 * {@link DisasterMaster}のプロパティ名の集合です。
 * 
 */
...
public class DisasterMasterNames {
    ...
    /**
     * menuprocessMastersのプロパティ名を返します。
     * 
     * @return menuprocessMastersのプロパティ名
     */
     ...
     * @author S2JDBC-Gen
     */
    public static class _DisasterMasterNames extends PropertyName<DisasterMaster> {

        /**
         * インスタンスを構築します。
         */
        public _DisasterMasterNames() {
        }
         ...
         *            名前
         */
        public _DisasterMasterNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _DisasterMasterNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
