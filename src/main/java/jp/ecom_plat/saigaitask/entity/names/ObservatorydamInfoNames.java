...
/**
 * {@link ObservatorydamInfo}のプロパティ名の集合です。
 *
 */
...
public class ObservatorydamInfoNames implements EntityNameInterface {

	@Override
	public String entityName() {
		return "Dam observatory info";
	}
     ...
     * @author S2JDBC-Gen
     */
    public static class _ObservatorydamInfoNames extends PropertyName<ObservatorydamInfo> {

        /**
         * インスタンスを構築します。
         */
        public _ObservatorydamInfoNames() {
        }
         ...
         *            名前
         */
        public _ObservatorydamInfoNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _ObservatorydamInfoNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
