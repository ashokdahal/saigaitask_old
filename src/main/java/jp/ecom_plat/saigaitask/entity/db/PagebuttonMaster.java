...
@lombok.ToString(exclude={"pagemenubuttonInfoList"})
public class PagebuttonMaster implements Serializable {
    ...
    /** ページボタン表示マスタリスト */
    @OneToMany(mappedBy = "pagebuttonMaster")
