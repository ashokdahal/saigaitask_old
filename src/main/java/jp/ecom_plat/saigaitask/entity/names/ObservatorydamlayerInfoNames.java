...
/**
 * {@link ObservatorydamlayerInfo}のプロパティ名の集合です。
 *
 */
...
public class ObservatorydamlayerInfoNames implements EntityNameInterface {

	@Override
	public String entityName() {
		return "Dam observatory layer info";
	}
     ...
     * @author S2JDBC-Gen
     */
    public static class _ObservatorydamlayerInfoNames extends PropertyName<ObservatorydamlayerInfo> {

        /**
         * インスタンスを構築します。
         */
        public _ObservatorydamlayerInfoNames() {
        }
         ...
         *            名前
         */
        public _ObservatorydamlayerInfoNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _ObservatorydamlayerInfoNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
