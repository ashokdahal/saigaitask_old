...
/**
 * {@link ObservMaster}のプロパティ名の集合です。
 * 
 */
...
public class ObservMasterNames {
     ...
     * @author S2JDBC-Gen
     */
    public static class _ObservMasterNames extends PropertyName<ObservMaster> {

        /**
         * インスタンスを構築します。
         */
        public _ObservMasterNames() {
        }
         ...
         *            名前
         */
        public _ObservMasterNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _ObservMasterNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
