...
/**
 * {@link MeteoriverMaster}のプロパティ名の集合です。
 * 
 */
...
public class MeteoriverMasterNames {
     ...
     * @author S2JDBC-Gen
     */
    public static class _MeteoriverMasterNames extends PropertyName<MeteoriverMaster> {

        /**
         * インスタンスを構築します。
         */
        public _MeteoriverMasterNames() {
        }
         ...
         *            名前
         */
        public _MeteoriverMasterNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _MeteoriverMasterNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
