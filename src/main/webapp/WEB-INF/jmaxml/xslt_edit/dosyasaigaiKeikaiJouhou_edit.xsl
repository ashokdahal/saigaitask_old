...
<xsl:template match="/">
	...
	<xsl:for-each select="jmx:Report/jmx_ib:Head/jmx_ib:Headline/jmx_ib:Information/jmx_ib:Item">
		...
		<!-- 種別名,type=comboboxsave,levelflag=1_field,groupid=2-->
		<xsl:value-of select="jmx_ib:Kind/jmx_ib:Name"/>

		<!-- 種別Code,type=combobox,levelflag=1_field,dbuid=dbdosyasaigaiwarncode,groupid=2-->
		...
		<xsl:for-each select="jmx_ib:Areas/jmx_ib:Area">
			...
			<!-- 領域コード,type=combobox,levelflag=1_1_field,dbuid=dbdosyasaigaiareacode,groupid=1 -->
