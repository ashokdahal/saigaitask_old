...
/**
 * {@link MeteotypeMaster}のプロパティ名の集合です。
 * 
 */
...
public class MeteotypeMasterNames {
     ...
     * @author S2JDBC-Gen
     */
    public static class _MeteotypeMasterNames extends PropertyName<MeteotypeMaster> {

        /**
         * インスタンスを構築します。
         */
        public _MeteotypeMasterNames() {
        }
         ...
         *            名前
         */
        public _MeteotypeMasterNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _MeteotypeMasterNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
